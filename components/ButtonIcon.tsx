...
const ButtonIcon: React.FC<Props> = ({ text, buttonType, icon, buttonClick }) => {
    const classes = (buttonType: ButtonIconTypeEnum): string => {
        ...
        if (buttonType === ButtonIconTypeEnum.SECONDARY) classes = ` ${classes} text-secondary-dark bg-secondary-light hover:bg-secondary-light`;
    ...
    const buttonIcon = (buttonType): string => {
        ...
        if (buttonType === ButtonIconTypeEnum.SECONDARY) classes = ` ${classes} bg-secondary-light hover:bg-secondary-light`;
